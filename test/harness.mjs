/**
 * Shared helpers for the GrantJudge integration scripts.
 *
 ...
 *
 * which reads like a contract fault and is not one: `claim_payout` ran, cleared
 ...
 * suite. GrantJudge's `_pay` posts its internal transfer with `on="finalized"`, deliberately:
