...
import { Coins, FilePlus2, HandCoins, Inbox, Wallet } from "lucide-react";
import { AppShell } from "@/components/AppShell";
import { ProposalBadge } from "@/components/StatusBadge";
import { TxButton } from "@/components/TxButton";
import { EmptyState, ErrorState, SkeletonGrid } from "@/components/States";
import { useMyProposals, usePayout } from "@/lib/hooks";
...
export default function MyProposalsPage() {
  ...
  return (
    <AppShell
      ...
      eyebrow="Your work"
      title="My proposals"
      blurb="Everything this address has filed, across every round, with what each one is owed."
      actions={
